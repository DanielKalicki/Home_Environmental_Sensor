...
/// SPS30 attached to a blocking esp-hal I2C bus.
    ...
    T: Instance,
{
    ...
    fn read_response(&mut self, command: u16, raw: &mut [u8], data: &mut [u8]) -> Result<(), Error> {
        self.send_command(command, SHORT_COMMAND_DELAY_MS)?;
    ...
    pub fn device_reset(&mut self) -> Result<(), Error> {
        self.send_command(CMD_DEVICE_RESET, RESET_DELAY_MS)
    }
    ...
    pub fn sleep(&mut self) -> Result<(), Error> {
        self.send_command(CMD_SLEEP, SHORT_COMMAND_DELAY_MS)
    }
    ...
    pub fn wake_up(&mut self) -> Result<(), Error> {
        ...
        self.delay.delay_millis(SHORT_COMMAND_DELAY_MS);
        self.send_command(CMD_WAKE_UP, SHORT_COMMAND_DELAY_MS)
    }
    ...
    pub fn serial_number(&mut self) -> Result<([u8; SERIAL_NUMBER_LEN], usize), Error> {
